...
t=['t0.jpg', 't1.jpg', 't2.jpg', 't3.jpg', 't4.jpg']
for i in range(0,5):
    t[i] = cv2.imread(t[i])
...
def move(N, start, destination):
        ...
        for x in range(0,k):
            for y in range(0,3):
                img[100+x*10:110+x*10, 100+y*100:200+y*100]= t[p2[x,y]]
...
if __name__ == '__main__':
    ...
    p1=np.zeros(shape=(k,3),dtype=np.uint8)
   # print(p1)
    for i in range(0,k):
        p1[i,0] = i+1 
    for x in range(0,k):
            for y in range(0,3):
                img[100+x*10:110+x*10, 100+y*100:200+y*100]= t[p1[x,y]]
                cv2.imshow('hanoi', img)   
    cv2.waitKey(0) 
    ...
    via = 2
    print(p1)
    total_count = hanoi(k, start, destination, via)
